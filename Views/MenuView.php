  ...
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
        ...
        <body >
                ...
                <ul class="sidebar-nav" id="sidebar-nav" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <!-- <li class="nav-item">
                        ...
                        <ul id="components-nav-factura" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                            ...
                            <li>
                                <a href="#" onclick="Menu.menu('ListInvoiceController/ListInvoice')" class="nav-link">
                                    <i class="bi bi-circle-fill"></i><span class="text-black">Listar facturas</span>
                                </a>
                            </li>
            ...
            <script src="assets/js/ListInvoice.js"></script>
