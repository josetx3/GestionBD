...
?>
                            ...
                            ?>
                                <tr class="text-center">
                                    ...
                                    <td style="text-align: center;">
                                        <i class="bi bi-pencil-fill" onclick="Product.showProduct('<?= $prod_reference ?>')"></i>
                                        <i class="bi bi-eraser-fill" onclick="Product.deleteProduct('<?= $prod_reference ?>')"></i>
                                    </td>
                                </tr>
                            <?php
                            }
    ...
    {
        $prod_id = $array_products->_id;
        $prod_reference = $array_products->prod_reference;
        $prod_code_plu = $array_products->prod_code_plu;
        $prod_description = $array_products->prod_description;
        $prod_available_quantity = $array_products->prod_available_quantity;
        $prod_arrival_price = $array_products->prod_arrival_price;
        $valor = $array_products->value;
        $prod_iva = $array_products->prod_iva;
            ...
            <div class="card-body">
                <form id="update_product">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="">Precio venta:</label>
                            <input type="number" class="form-control" name="u_prod_selling_price" id="u_prod_selling_price" value="<?= $valor ?>" onkeypress="return solonumeros(event);">
                        </div>
                        ...
                        <input type="hidden" id="id" name="id" value="<?= $prod_reference ?>">
                        <br>
