    ...
    ?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($array_persons as $object_person) {
                                    $document = $object_person->acces->acce_document;
                                    $name1 = $object_person->acces->acce_name1;
                                    $name2 = $object_person->acces->acce_name2;
                                    $lastname1 = $object_person->acces->acce_lastname1;
                                    $lastname2 = $object_person->acces->acce_lastname2;
                                    $address = $object_person->acces->acce_address;
                                    $sex = $object_person->acces->acce_sex;
                                    $telephone_number = $object_person->acces->acce_telephone_number;
                                    $email = $object_person->acces->acce_email;
                                    $pasword = $object_person->acces->acce_password;
                                    $emti_id = $object_person->emti_name;
                                    $acce_state = $object_person->acces->acce_state;
                                ?>
                                    <tr class="text-center align-items-center">
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <i class="bi bi-eraser-fill" onclick="Person.deletePerson('<?= $document ?>')"></i>
                                        </td>
                                    </tr>
                                <?php
                                }
        ...
        function showPerson($array_persons)
        {
            $document = $array_persons->acces->acce_document;
            $name1 = $array_persons->acces->acce_name1;
            $name2 = $array_persons->acces->acce_name2;
            $lastname1 = $array_persons->acces->acce_lastname1;
            $lastname2 = $array_persons->acces->acce_lastname2;
            $address = $array_persons->acces->acce_address;
            $telephone_number = $array_persons->acces->acce_telephone_number;
            $email = $array_persons->acces->acce_email;
            $pasword = $array_persons->acces->acce_password;
            $acce_state = $array_persons->acces->acce_state;
            $sex = $array_persons->acces->acce_sex;
                ...
                <div class="card-body">
                    <form id="update_Person">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="">Sexo:</label>
                                <input type="text" class="form-control" name="u_sex" id="u_sex" value="<?= $sex ?>">
                            </div>
