...
?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            foreach ($array_clients as $object_client) {
                                $cliente_documento = $object_client->client_document;
                                $cliente_nombre = $object_client->client_name;
                                $cliente_correo = $object_client->client_email;
                                $cliente_sexo = $object_client->client_sex;
                                $cliente_telefono = $object_client->client_telephone;
                                $cliente_direccion = $object_client->client_address;
                                $cliente_barrio = $object_client->client_neighborhood;
                                $cliente_nombre_negocio = $object_client->client_name_business;
                                $cliente_nit_negocio = $object_client->client_nit_business;
                                $cliente_estado = $object_client->client_satus;
                            ?>
                                <tr class="text-center align-items-center">
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <i class="bi bi-eraser-fill" onclick="Client.deleteClient('<?= $cliente_documento ?>')"></i>
                                    </td>
                                </tr>
                            <?php
                            }
    ...
    {
        $cliente_documento = $array_clients->client_document;
        $cliente_nombre = $array_clients->client_name;
        $cliente_correo = $array_clients->client_email;
        $cliente_sexo = $array_clients->client_sex;
        $cliente_telefono = $array_clients->client_telephone;
        $cliente_direccion = $array_clients->client_address;
        $cliente_barrio = $array_clients->client_neighborhood;
        $cliente_nombre_negocio = $array_clients->client_name_business;
        $cliente_nit_negocio = $array_clients->client_nit_business;
        $cliente_estado = $array_clients->client_satus;
    ?>
