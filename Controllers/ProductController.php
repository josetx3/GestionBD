...
class ProductController
{
    function paginateProduct()
    {
        ...
        $product = $ProductModel->listProduct();
        $ProductView->paginateProduct($product);
    }
    ...
    function showProduct()
    {
        ...
        $ProductView->showProduct(json_decode($array_products));
    }
    ...
    function deleteProduct()
    {
        ...
        $ProductView = new ProductView();
        $prod_code_plu = $_POST['id'];
        $array_products = $ProductModel->deleteProduct($prod_code_plu);
        $array_products = $ProductModel->listProduct();
        $ProductView->paginateProduct($array_products);
    }
