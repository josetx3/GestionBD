...
class PersonController
{
    ...
    function updatePerson()
    {
        ...
        //exit($document);
        $array_persons =  $PersonModel->updatePerson($document, $name1, $name2, $lastname1, $lastname2, $address, $telephone, $email, $pasword, $acce_state, $sex);
        $array_persons = $PersonModel->listPerson();
        $array_positions = $PositionModel->listPosition();
        $PersonView->paginatePerson($array_persons, $array_positions);
    }
    ...
    function showPerson()
    {
        ...
        $array_positions = $PositionModel->listPosition();
        $PersonView->showPerson(json_decode($array_persons), $array_positions);
    }
    ...
    function deletePerson()
    {
        ...
        $PersonView = new PersonView();
        $document = $_POST['id'];
        $array_persons = $PersonModel->deletePerson($document);
        $array_persons = $PersonModel->listPerson();
